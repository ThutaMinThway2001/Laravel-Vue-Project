...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_components$name$data = {
  components: {
    Button: vform_src_components_bootstrap5__WEBPACK_IMPORTED_MODULE_4__.Button,
    HasError: vform_src_components_bootstrap5__WEBPACK_IMPORTED_MODULE_4__.HasError,
    AlertError: vform_src_components_bootstrap5__WEBPACK_IMPORTED_MODULE_4__.AlertError
  },
  ...
  data: function data() {
    return {
      ...
      products: {},
      isEdit: false,
      product: new vform__WEBPACK_IMPORTED_MODULE_1__["default"]({
        id: '',
        name: '',
        detail: ''
      })
...
}, _defineProperty(_components$name$data, "components", {
  Loading: (vue_loading_overlay__WEBPACK_IMPORTED_MODULE_2___default())
}), _defineProperty(_components$name$data, "methods", {
  view: function view() {
    var _this = this;
    ...
    this.isLoading = true;
    this.$Progress.start();
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("http://127.0.0.1:8000/api/products?page=".concat(page, "&search=").concat(this.search)).then(function (response) {
  ...
  storeProduct: function storeProduct() {
    ...
    this.product.post('http://127.0.0.1:8000/api/products/').then(function (response) {
      _this2.view();

      _this2.product.reset();
  ...
  updateProduct: function updateProduct() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().put('api/products/' + this.product.id, this.product).then(function (response) {
      _this3.view();

      _this3.product.reset();
...
}), _defineProperty(_components$name$data, "created", function created() {
  this.view();
...
vue__WEBPACK_IMPORTED_MODULE_2__["default"].use((vue_progressbar__WEBPACK_IMPORTED_MODULE_1___default()), {
...
vue__WEBPACK_IMPORTED_MODULE_2__["default"].component('product-component', (__webpack_require__(/*! ./components/ProductComponent.vue */ "./resources/js/components/ProductComponent.vue")["default"]));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductComponent_vue_vue_type_template_id_9e91ef8e___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductComponent_vue_vue_type_template_id_9e91ef8e___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ProductComponent_vue_vue_type_template_id_9e91ef8e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ProductComponent.vue?vue&type=template&id=9e91ef8e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ProductComponent.vue?vue&type=template&id=9e91ef8e&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ProductComponent.vue?vue&type=template&id=9e91ef8e&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/ProductComponent.vue?vue&type=template&id=9e91ef8e& ***!
  \****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      _c("div", { staticClass: "col-md-4" }, [
        _c("div", { staticClass: "card" }, [
          _c("div", { staticClass: "card-header bg-dark text-white " }, [
            _c("h4", [_vm._v(_vm._s(_vm.isEdit ? "Edit" : "Create"))]),
          ]),
          _vm._v(" "),
            ...
            _c(
              "form",
              {
                ...
                on: {
                  submit: function ($event) {
                    $event.preventDefault()
                    _vm.isEdit ? _vm.updateProduct() : _vm.storeProduct()
                  },
                },
              },
              [
                _c("AlertError", {
                  attrs: { form: _vm.product, message: _vm.message },
                }),
                _vm._v(" "),
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _vm._v(" "),
                  _vm.product.errors.has("name")
                    ? _c("div", {
                        staticClass: "text-danger",
                        domProps: {
                          innerHTML: _vm._s(_vm.product.errors.get("name")),
                        },
                      })
                    : _vm._e(),
                ]),
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _vm._v(" "),
                  _vm.product.errors.has("detail")
                    ? _c("div", {
                        staticClass: "text-danger",
                        domProps: {
                          innerHTML: _vm._s(_vm.product.errors.get("detail")),
                        },
                      })
                    : _vm._e(),
                ]),
        ...
        _c(
          ...
          [
            ...
            _c("pagination", {
              ...
              on: { "pagination-change-page": _vm.view },
            }),
            _vm._v(" "),
            _c("loading", {
...
var staticRenderFns = [
  ...
  function () {
    ...
    return _c(
      "button",
      {
        staticClass: "btn btn-success btn-sm mt-3 float-end",
        attrs: { type: "submit" },
      },
      [
        _c("i", { staticClass: "far fa-save me-1" }),
        _vm._v("Save\n                        "),
      ]
    )
  },
